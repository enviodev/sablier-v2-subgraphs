...
let trackAllTables = async () => {
  ...
  let _ = await trackTable(~tableName="Activity")
  let _ = await createSelectPermissions(~tableName="Activity")
  let _ = await trackTable(~tableName="Asset")
  let _ = await createSelectPermissions(~tableName="Asset")
  let _ = await trackTable(~tableName="Campaign")
  let _ = await createSelectPermissions(~tableName="Campaign")
  ...
  let _ = await createEntityRelationship(
    ...
    ~derivedFromFieldKey="",
    ~relationalKey="campaign",
    ~mappedEntity="Campaign",
  )
  let _ = await createEntityRelationship(
    ~tableName="Activity",
    ~relationshipType="object",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="object",
    ~derivedFromFieldKey="",
    ~relationalKey="factory",
    ~mappedEntity="Factory",
  )
  let _ = await createEntityRelationship(
    ~tableName="Campaign",
    ~relationshipType="object",
    ~derivedFromFieldKey="",
    ~relationalKey="clawbackAction",
    ~mappedEntity="Action",
  )
  let _ = await createEntityRelationship(
    ~tableName="Campaign",
    ~relationshipType="array",
    ~derivedFromFieldKey="campaign",
  ...
  let _ = await createEntityRelationship(
    ...
    ~relationshipType="array",
    ~derivedFromFieldKey="campaign",
    ~relationalKey="activities",
    ~mappedEntity="Activity",
  )
  let _ = await createEntityRelationship(
    ~tableName="Factory",
    ~relationshipType="array",
    ~derivedFromFieldKey="factory",
    ~relationalKey="campaigns",
    ~mappedEntity="Campaign",
  )
}
